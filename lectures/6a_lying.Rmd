...
>.smaller[**Instructions:** In each matrix below, find two numbers that add up to 10. You have three minutes, so solve them as quickly as you can! Write down your answers on a piece of scratch paper.]
...
>.smaller[**Instructions:** Let's calculate our group average so that we can compare it to some studies later. Compare your answers to the answer key and calculate how many you solved correctly.]
...
???
A third, hybrid hypothesis about honesty; e.g., a goal of making a friend, having a good time, etc.
...
.smallest-picture[![](images/matrix task.JPG)]
---
...
- Participants were randomly assigned to one of two conditions
  .smaller[- **The shredder condition**: participants shredded their matrix worksheet and then self-reported the number of matrices they solved
...
- Participants also filled out the HEXACO-100 Honesty-Humility subscale
...
.right-column-med[
![](images/situation_disposition_interaction.JPG)]
...
.left-column-med[#### Dispositional factors
.smaller[
...
.left-column-med[#### Situational factors
.smaller[
...
# Peer influence
.footnote[Gino, Ayal, & Ariely (2009)]
####Method
...
- **The control condition**: the participants handed their solved matrices to the experimenter, who counts the solved ones and gave the appropriate money amount
...
- **The in-group condition**: the shredder condition with the addition of a confederate (after one minute) who shredded his paper and said "I solved everything. My envelope for the unearned money is empty. What should I do with it?"
...
####Results 
- Participants scored significantly higher in conditions where individuals shredded their papers

- Participants cheated more when they watched the confederate get away with cheating, but less when that confederate was a member of the out-group ]
...
.dq-c[.smaller[Why do you think seeing an out-group member cheating did not increase cheating?]]
]
...
.smaller[- Observing an in-group member acting unethically changes the social norms associated with the act; cheating can become acceptable in a narrow situation
...
.dq[.smaller[Is this a good experimental design for detecting cheating? ]]

???

Consider confounds, demand effects, and external and ecological validity.
...
- They were shown 100 trials of stimuli and were instructed to indicate whether there were more dots on the left or right side
...
- Out of 100 stimuli: 
  ...
  - 34 contained clearly more on the left 
  - 16 contained clearly more on the right 

- Choosing the right side represented self-interest (ambiguous), cheating (clearly on left), or telling the truth (clearly on right)
...
- People may have less willpower and/or may be more tired in the afternoon, leading them to more dishonest behavior


]
.right-column-med[
![](images/morning effect.JPG)]
...
.pull-left[####Discussion


.dq-c[ Is this a good experimental design for detecting cheating?] 
...
# Darkness
.footnote[Zhong, Bohns, & Gino (2010)]
####Method
...
.left-column-med[####Discussion

.dq-c[Why do you think people would cheat more in a dark room?]
...
Darkness makes people feel anonymous
...
.pull-right[
![](images/groups_cheating.png)]

???
- Each condition's opponent started out with a different amount of money so that deductions would be the same 
---
...
.left-column-med[####Results (study 1)
...
- Participants were just as likely to be dishonest, regardless of if they were taking 13 cents or 50 cents per person


]

.right-column-med[
![](images/group_cheating_2.png)]

---
# Individual or group victim
.footnote[Amir, Kogut, & Bereby-Meyer (2016)]

.left-column-med[####Discussion (study 1)
...
.right-column-med[![](images/token.png)]
...
- Participants solved more problems in the recycle + token condition than they did in the recycle condition

.dq-c[ .smaller[What are the implications of this finding in a digital world?]]
]
.right-column-med[![](images/token.png)]

???

suggesting that token payments increased cheating over money payments
---
...
.dq[.smaller[Think about a situation where someone lied or cheated you. Were any of these factors present?]]

???

Or do you think that the action should be solely attributed to their disposition and not the situation?
...
####Method (study 1)
.smaller[- Participants filled out various surveys (including a survey measuring the dark triad personality traits)
...
.smaller[- Participants played the same coin flipping task as in study 1. Half of the participants read the warning message from study 1:
...
.smaller[- Less people cheated in the low risk condition (10%) than the high risk condition (17%)

- Even under high risk, impulsive psychopaths risked their mTurk reputation for the extra money

- Individuals high in Machiavellianism cheated under low risk but not high risk 
]
]
.right-column-med[
![](images/triad_3.JPG)]
...
.smaller[- Participants completed the Remote Association task (the RAT) to measure creativity. In the RAT task, participants need to think of a word that links three words together.

>What logically links these words? <center><i>Sore, shoulder, sweat</i></center>

- Participants also completed the matrix task. They could earn $1 for each correct answer that they self-reported (their actual answers were unknowingly saved)]
...
.smaller[The researchers suggest that cheating causes one to become more creative (because it makes people feel like they are less constricted by rules)]

.dq-c[.smaller[What is an alternate explanation of this finding?]]
...
- Participants were randomly assigned to one of two conditions:
  ...
  - **The anxiety condition**:  listened to anxiety inducing music clip
  - **The neutral condition**:  listened to a clip of air
  
- Participants read 13 scenarios (some of which depicted unethical behavior) and rated how likely they were to engage in the behavior described

>  .smallish[“You work as an office assistant for a department at a University. You’re alone in the office making copies and realize you’re out of copy paper at home. You therefore slip a ream of paper into your backpack.”]
]
...
- An anxiety inducing situation (i.e., *state anxiety*) can increase dishonesty

- Additionally, the authors found that *trait anxiety* was also related to dishonest behavior

  - People who tend to feel anxious tend to also act more dishonestly

--

.dq[Did any of these factors surprise you?]
...
- People who score high on dark traid traits behave more dishonestly than those who score low
  ...
  - Psychopathy is associated with risky and unrisky unethical behavior, whereas machiavellianism is associated only with unrisky unethical behavior
...
.highlight-blue[Next class:] Midterm!