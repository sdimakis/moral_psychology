...
Researchers presented 18-month-old infants with different situations where the experimenter was having trouble reaching a goal 
...
- **Wrong result**: the experimenter needs help because they are trying to complete a task but are using the wrong means to do it
