...
# .smaller[The Domain Theory of Attitudes]
...
Attitudes that fall under the **moral imperative domain** are called *moral convictions* and they have unique properties, including:
...
- Participants arrived at the lab with a group of strangers and were told that they would be sharing opinions in their group about the use of torture 

- They were asked to what extent their attitude towards stress interrogation techniques reflect their core moral values ]
...
#### Method
- Participants first talked in chat rooms with people that they thought were their group members (`r fontawesome::fa("desktop", fill = "gray")`)
  ...
  - **Social support condition:** Same as social support condition except slight opposition instead of slight support


- Participants then talked in person with actual group members (`r fontawesome::fa("users", fill = "gray")`)
...
# .smaller[Unwillingness to compromise]
...
.dq[How does an attitude become a "moral conviction"?] 
...
- Researchers exposed students to how animals suffer from human meat consumption across a semester 
...
.right-column-med[
![](images/moralization feinberg 2019 2.JPG)]
...
indeed any mingling with secular values." .right[-Philip Tetlok (2003)]



---

# .smallish[The Sacred Value Protection Model]
...
.left-column-med[
#### Results
.smaller[- Individuals were more outraged when the decision maker chose the secular value (the hospital) over the sacred value (saving Johnny)
...
- Then, they rated how difficult the decision is and how strongly they are experiencing negative emotions
...
.highlight-blue[Next class:] Religion and morality