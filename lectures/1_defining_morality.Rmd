...
--
.smaller-picture[![](images/review_paper.JPG)]
...
3. Morality is care/harm
2. The model of moral motives
4. Relationship regulation theory
...
Meaningful differences arise when individuals disagree about which actions are harmful.
...
.left-column-big[Rai also believes that MFT does not fully capture the scope of moral disagreements. He argues that the the determination of if an action is right cannot be determined outside of its social-relational context. 
