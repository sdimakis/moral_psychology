...
<style>
div.blue {background-color:#e6f0ff; border-radius: 10px;   border: 1px solid black; padding: 10px 5px;}
</style>

<style>
div.gray { background-color:#ededed; border-radius: 10px;   border: 1px solid black; padding: 10px;}
</style>

<style>
div.gray-sub { background-color:#ededed; border-radius: 10px;   border: 1px solid black; padding: 10px; margin 10px;}
</style>
...
Attending class, turning in your assignments on time, and actively participating in group and class discussion is incredibly important to succeed in this course, so participation has been given a part of your grade to reflect its importance. 
