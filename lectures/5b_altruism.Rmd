...
- Cohn et al. (2019) performed a missing wallet experiment in 40 countries with more than 17,000 wallets
...
- They measured if the person did or did not contact the owner of the wallet
...
.right-column-med[<br>![](images/cohn_wallet_1.JPG)]

.left-column-med[- Some wallets had money in them while others had no money
...
.left-column-med[
- Further, when a "big money" condition ($94.15) was added, people were even more likely to return the wallet (see Figure)
...
.smallest-picture[![](images/cohn_5.JPG)]
- These findings were contrary to the expectations of expert economists, and contrary to the expectations of non-experts (see Figure)
...
>.highlight-gray[Discussion question:] Think about a recent behavior that you did that was *altruistic*. Would you consider the act **purely** altruistic, or did you also benefit from it?

???

We also saw that monkeys were not helping strangers like we do
---

# Altruism 

.footnote[Batson and Shaw (1991)]
Batson and Shaw (1991) describe three pathways to helping, two of which are egoistic (i.e., selfish) and one of which they claim is altruistic
...
---
# Egoistic motivations for helping
.footnote[Batson and Shaw (1991)]
...
.smallest-picture[![](images/pain-brain.png)]

- Participants were shown animated hands or feet in painful (e.g., a finger getting stuck in a door) and non-painful situations

- They were told to imagine it was their hand/foot, their love one's, or a stranger's

- **Conclusion**: similar pain regions of the brain are activated for the self and for others (especially close others)
...
>.highlight-gray[Discussion question:] What is the benefit of appearing altrustic to others? How do people signal to others that they are virtuous? 



---

# Protecting your moral reputation
...
.pull-right[<br>You would get a swastika tattooed prominently on your face. Everyone you met would assume you were a Neo-Nazi when they saw you. You would not be allowed to explain to anyone, including family, friends, and strangers, why you have the tattoo on your face.]
...
.pull-right[<br>You will live into your 90s, but everyone in your community will think you are a pedophile who sexually abuses children (you will not actually be a pedophile, but will have no way of proving you are not.)]
...
.pull-right[You will live into your 90s, and everyone will hold you in high
...
.right-column-small[![](images/stress.jpg)]


- Participants took an IAT test

- They were randomly assigned to a low or high implicit racism score 
...
- They were then told that if they participated in another experiment, their score would not be included in the broadcast
...
- **Conclusion**: people give because they want to *appear* selfless and fair, but they would actually rather keep the money]
...
- In the private condition, the receiver will not know where the money came from. The money will be given to them with the following note:
  
> "Thank you for your time today. An additional payment of $___ is attached to this note."

- In the private condition, after making an allocation decision, participants were also given the choice to exit and take $9
...
- **Conclusion**: people exit in the public condition because they are concerned about what the person will think about their gift (e.g., is it big enough?) but even when the gift is private, people feel compelled to give]


.highlight-blue[Discussion question]: does private make the gift *altruistic*?
---
# Dictator exit study
.footnote[Dana et al. (2005)]
Study 2
...
- .highlight-blue[**Discussion question**]: is the private gift *altruistic*?]
...
- Most women are better off at home taking care of the children.

- Men are more emotionally suited for politics than are most women.

- The best job for most women is something like cook, nurse, or teacher.

- Most women need a man to protect them.
...
- Some women are better off at home taking care of the children.

- Men are more emotionally suited for politics than are some women.

- The best job for some women is something like cook, nurse, or teacher.

- Some women need a man to protect them.
...
.smallest-picture[![](images/monin cred.JPG)]

- Overall, women preferred a man for the job at the same rate, regardless of the condition they were in

- However, men with "moral credentials" (who had just stated that they were not sexist) preferred a man for the job at a higher rate than men who did not have "moral credentials"

--

- **Conclusion:** people are more likely to express an attitude that could be considered prejudiced when they have a reputation of not being prejudiced 

---

# An "altruistic" motivation for helping
.footnote[Batson and Shaw (1991)]
...
<center><br>
<iframe width="560" height="315" src="https://www.youtube.com/embed/-Uc3Xdry4SM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</center>
...
Until 4:12 will be good
---
# Empathy is unreliable and flawed
...
# Empathy is unreliable and flawed
.footnote[Bloom (2013)]
> "Newtown, in the wake of the Sandy Hook massacre, was inundated with so much charity that it
...
federal food-stamp program is facing budget cuts of almost twenty per cent."
...
.smallest-picture[![](images/slovic.JPG)]

- Small, Loewenstein, and Slovic (2007) gave participants $5 and then recorded how much of it they donated to the *Save the Children* organization
...
--
- **Conclusion:** people donated over twice as much for an identifiable victim than for statistics about the issue
...
Batson and Shaw (1991) argue that empathic concern is the only way to reach purely unselfish altruism, but according to Paul Bloom, empathy is often a poor compass for moral action

>.highlight-gray[Discussion question:] Are you convinced by Bloom's argument? Do you think the world would be more moral if people were more empathetic, or if people were more rational? 

>.highlight-gray[Discussion question:] Does it matter if something is *truly* altruistic? Or is a good act still good, even when the motivations are selfish? 
...
- People often go out of their way to help others, but even strangers 

- There are selfish reasons to be altruistic, such as to feel good or to build a moral reputation

- People care *a lot* about whether others think they are moral
...
- Empathy may be the key to "pure" altruism, but empathy may not always lead to moral decision making