...
.highlight-gray[Discussion question:] Which of the following warnings do you think would most defer a person from cheating, and why?

.pull-left[Option 1:

I will give extra credit to anyone who is thinking the same number as me. Please don't cheat by going to the website and looking at the next slide.

]

.pull-right[Option 2:

I will give extra credit to anyone who is thinking the same number as me. Please don't be a cheater by going to the website and looking at the next slide.
]

---

# Protecting the moral self

.footnote[Bryan, Adams, & Monin (2013)]

Method

- Bryan, Adams, & Monin (2013) asked for volunteers for a study about psychokinesis
...
- .highlight-gray[Discussion question]: Should we apply this work everywhere, e.g., "please don't be a litterer," "please don't be a drunk driver", or do you foresee any negative consequences of this style of behavior change?
...
.smallest-picture[![](images/speeding.jpg)]

- People are able to compromise by cheating a little, but only enough so that it does not threaten their positive self-concept
...
Stealing pencils vs. money from work, or stealing tokens vs. money (experiment we talked about in dishonesty lecture)
...
- Participants were randomly assigned to one of the four combinations:
...
- In the recycle condition, participants did not cheated after reciting books they read in high school but not after reciting the 10 commandments]
...
- This study provided evidence for the *attention to standards* hypothesis, that individuals are less likely to cheat when they are reminded of their moral values

- Additionally, people did not cheat **very much**, only about 1-2 matrices on average, when they could have reported solving up to 20 matrices]
...
- Think for a minute about this finding. What does this suggest?
]
...
- The money manipulation was not significant, although this may be because $.50 is not different enough from $2 (see Wallet study from Altruism lecture)]
...
- When a "big money" condition ($94.15) was added, people were even more likely to return the wallet (see Figure)

- .highlight-gray[Discussion question]: How does this finding support self-concept maintenance theory? 
...
- This study provided further evidence for the *attention to standards* hypothesis, that individuals are less likely to cheat when they are reminded of their moral values
...
- This suggests that the addition of token payments increased cheating, providing evidence for the *categorization* hypothesis
...
.smaller-picture[![](images/self serving justifications.JPG)]
...
???
Visual perception - people are more likely to choose the 5 cent side when it is more ambiguous than when it is clearly on the other side

Dice task - participants were asked to roll a dice one or three times. For both, the first roll determines your pay (higher numbers better). The participants who rolled 3 times reported a higher number because they had rolled the higher number at some point which is a smaller lie than when they hadn't rolled the number at all
---
...
- .highlight-gray[Discussion question:] What do you think people prefer to give: partial or full confessions? Why?
...
- **Self**: Acted selfishly in a task and rated how fair their behavior was

- **Other**: Rated how fair it is to act selfishly in the task


Participants who acted unfairly rated themselves as being more fair than strangers rated them
...
Bandura et al. (1996) created a model for how people are able to violate their moral standards when the situation necessitates it (e.g., a soldier at war)
...
- Can you think of another example of moral justification? 
...
- Can you think of another example of palliative comparison? 
...
- Can you think of another example of euphemistic language? 
...
- Can you think of another example of displacement of responsibility? 
...
- Can you think of another example of diffusion of responsibility? 
...
People are motivated to minimize the harm they cause to others, recalling much easier the potential benefits of their actions than the harms
...
- Can you think of another example of minimizing or ignoring consequences? 
...
- Can you think of another example of dehumanization? 
...
- Can you think of another example of attribution of blame? 
...
- Shalvi et al. (2015) theorize that we use pre- and post-violation **self-serving justifications** to avoid threats to our self-concept when we violate our moral standards
  - Pre-violation justifications allow someone to act labeling the act a "gray area", whereas post-violation justifications make someone feel better about their violation
